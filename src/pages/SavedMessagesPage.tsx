...
export default function SavedMessagesPage() {
  ...
  const iconForType = (type: string) => {
    switch (type) {
      ...
      case 'video': return <ImageIcon size={16} className="text-destructive" />;
      case 'file': return <File size={16} className="text-[#8B5CF6]" />;
      case 'location': return <MapPin size={16} className="text-destructive" />;
        ...
        <div className="px-4 pb-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-secondary rounded-xl pl-9 pr-9 py-2.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary placeholder:text-muted-foreground"
            />
            {search && (
            ...
            >
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                <button type="button" onClick={() => {
                  ...
                  className="text-destructive text-xs flex items-center gap-1 hover:bg-destructive/10 px-2 py-1 rounded-lg transition-colors"
                >
