...
export default function SentRequestsPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-secondary flex flex-col">
      {/* Header */}
      <div className="bg-card border-b border-border flex items-center gap-3 p-4 sticky top-0 z-10">
              ...
              {sentRequests.map((req, i) => (
                ...
                >
                  ...
                  <button type="button" onClick={() => handleCancel(req.id)}
                    className="flex items-center gap-1 px-3 py-1.5 bg-secondary text-destructive text-xs rounded-full font-medium active:bg-gray-100 transition-colors"
                  >
                    <X size={12} /> Cancel
                  </button>
                </motion.div>
