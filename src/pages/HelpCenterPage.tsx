  ...
  return (
    <div className="h-full flex flex-col bg-card">
      ...
      <div className="shrink-0 px-4 py-3 border-b border-border flex items-center gap-3">
        <button type="button" onClick={() => navigate(-1)} className="p-1.5 rounded-lg hover:bg-secondary text-muted-foreground">
          <ArrowLeft size={20} />
        </button>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-4">
          <p className="text-muted-foreground text-sm mb-6">
            ...
            <a href="mailto:support@gagachat.app" className="text-primary underline">support@gagachat.app</a>
          </p>
