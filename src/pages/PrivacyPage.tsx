...
export default function PrivacyPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-secondary">
      ...
      <div className="mt-4 bg-card border-y border-border p-4">
      ...
      <div className="mt-4 bg-card border-y border-border p-4">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <p className="text-foreground text-sm font-medium">Story Privacy</p>
            <p className="text-muted-foreground text-xs">Who can see your stories</p>
          </div>
        </div>
        <div className="flex gap-2">
      ...
      <div className="mt-4 mx-4 bg-card border border-border rounded-2xl p-4">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-primary text-xs">Enabled</p>
          </div>
        </div>
