    ...
    return (
        <div className="min-h-[100vh] bg-muted">
            ...
            <div className="max-w-5xl mx-auto px-4 py-8 space-y-5">
                ...
                {posts.map((post) => (
                    <article key={post.title} className="bg-background border border-border rounded-2xl p-5 md:p-6 hover:border-[#00C300]/30 transition-colors">
                        ...
                        <Link to="/help" className="inline-flex items-center gap-1 text-sm font-semibold text-foreground hover:text-[#00C300]">
