    ...
    <div className="min-h-[100dvh] bg-secondary flex flex-col">
      ...
      <div className="shrink-0 flex items-center justify-between px-4 py-3 bg-card border-b border-border">
        ...
        <button type="button" onClick={handleCreate}
          ...
          className="text-primary font-bold text-sm disabled:text-muted-foreground active:opacity-60"
        >
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide pb-8">
        ...
        <div className="bg-card p-4 space-y-4">
          <div className="flex items-center gap-4">
            {/* Avatar Upload */}
            <button type="button" className="w-16 h-16 rounded-full bg-secondary flex items-center justify-center text-muted-foreground shrink-0 relative overflow-hidden"
        ...
        <div className="px-4 py-3 flex items-center justify-between">
          ...
          <span className="text-primary text-sm font-medium">{selectedFriends.length} selected</span>
        </div>
