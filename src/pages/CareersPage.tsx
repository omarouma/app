    ...
    return (
        <div className="min-h-[100dvh] bg-secondary">
            ...
            <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
                ...
                <section className="bg-card border border-border rounded-3xl p-6 md:p-8">
                    <h3 className="text-xl font-bold text-foreground mb-3">Open roles</h3>
                    <div className="space-y-3 text-sm text-muted-foreground">
                        ...
                        <div className="flex items-center justify-between gap-3">
                            <span className="font-medium text-foreground">Community & Safety Specialist</span>
                            <span>Remote</span>
                        </div>
                    </div>
                    <p className="mt-5 text-sm text-muted-foreground">
                        Send your resume to <a href="mailto:careers@gagachat.app" className="text-primary underline">careers@gagachat.app</a> and tell us what kind of impact you want to build.
                    </p>
                </section>
            </div>
        </div>
