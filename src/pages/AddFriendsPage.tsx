...
function UserCard({ user, status = 'not_friends', mutualCount = 0, distance, suggestionReason, onNavigate, disableNavigation }: UserCardProps) {
      ...
      case 'request_sent':
        return (
          <div className="flex items-center gap-2">
            <span className="flex items-center gap-1 px-3 py-1.5 bg-muted text-muted-foreground text-xs rounded-full font-medium">
        ...
        return (
          <div className="flex items-center gap-1">
            ...
            <button type="button" onClick={(e) => handleAction('reject', e)}
              className="flex items-center gap-1 px-3 py-1.5 bg-muted text-muted-foreground text-xs rounded-full font-medium"
            >
              <X size={18} /> Decline
            </button>
          </div>
  ...
  return (
    <motion.div
      ...
      onClick={handleClick}
      className={`flex items-center gap-3 p-4 bg-background rounded-xl border border-border ${!disableNavigation ? 'cursor-pointer active:bg-muted' : ''} transition-colors`}
    >
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-3">
              <button type="button" onClick={() => setShowQrModal(true)}
                className="flex items-center gap-2 justify-center p-3 bg-background border border-border rounded-xl text-sm font-medium text-foreground active:bg-muted transition-colors"
              >
            ...
            <div className="bg-background border border-border rounded-2xl p-4">
              <div className="relative mb-3">
                ...
                <input
                  ...
                  className="w-full bg-muted rounded-xl pl-10 pr-10 py-3 text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-[#00C300] placeholder:text-muted-foreground"
                />
                {searchQuery && (
                ...
                <div className="space-y-2">
                  {pendingRequests.map((req) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className="w-12 h-12 rounded-full bg-muted flex items-center justify-center overflow-hidden shrink-0 cursor-pointer"
          ...
          >
            ...
            >
              ...
              <div className="bg-muted rounded-2xl p-6 mb-4">
                <div className="w-48 h-48 mx-auto bg-background rounded-xl p-4 flex flex-col items-center justify-center gap-3">
              ...
              <div className="flex gap-2">
                <button type="button" onClick={() => { handleCopyLink(); setShowQrModal(false); }}
                  className="flex-1 flex items-center justify-center gap-2 py-3 bg-muted text-foreground rounded-xl text-sm font-bold"
                >
    ...
    <div className="space-y-2">
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 bg-muted rounded-xl px-4 py-3 text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-[#00C300] placeholder:text-muted-foreground"
        />
      ...
      <button type="button" onClick={() => fileRef.current?.click()}
        disabled={scanning}
        className="w-full flex items-center justify-center gap-2 py-2.5 bg-muted text-muted-foreground rounded-xl text-xs font-medium hover:text-foreground transition-colors"
      >
