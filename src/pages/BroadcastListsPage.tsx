    ...
    <div className="h-[100dvh] bg-secondary flex flex-col">
      ...
      <div className="bg-card border-b border-border shrink-0">
        <div className="flex items-center gap-3 p-4">
          <button type="button" onClick={() => navigate(-1)} className="p-2 -ml-2 hover:bg-secondary rounded-full text-foreground">
            <ArrowLeft size={22} />
          </button>
          <h1 className="text-lg font-bold text-foreground flex-1">Broadcast Lists</h1>
          <button type="button" onClick={() => setShowCreate(true)} className="p-2 hover:bg-secondary rounded-full text-primary">
            <Plus size={22} />
          </button>
        </div>
      </div>
                ...
                <div className="flex items-center gap-3 p-4">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="px-3 py-1.5 bg-primary text-white rounded-full text-xs font-medium hover:bg-[#00A300] transition-colors"
                    >
                      Send
                    </button>
                    <button
        ...
        {showCreate && (
          ...
          >
            <motion.div
              ...
              className="bg-card rounded-t-2xl sm:rounded-2xl w-full max-w-sm max-h-[85vh] flex flex-col"
              onClick={e => e.stopPropagation()}
            >
              <div className="p-4 border-b border-border flex items-center justify-between shrink-0">
                <h3 className="text-lg font-bold text-foreground">New Broadcast List</h3>
                <button type="button" onClick={() => setShowCreate(false)} className="p-2 hover:bg-secondary rounded-full">
              ...
              <div className="p-4 space-y-4 overflow-y-auto flex-1">
                ...
                <div>
                  ...
                  <div className="bg-secondary rounded-xl p-2.5 flex items-center gap-2 mb-2">
                    ...
                    <input
                      ...
                      className="bg-transparent border-none focus:outline-none text-[15px] w-full text-foreground placeholder-[#8D8D8D]"
                    />
                  </div>
                      ...
                      {filteredFriends.map(f => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-full flex items-center gap-3 p-3 rounded-xl transition-colors text-left ${isSelected ? 'bg-primary/10 border border-primary/20' : 'hover:bg-secondary'
                              }`}
                          >
              ...
              <div className="p-4 border-t border-border shrink-0">
                <button
                  ...
                  className="w-full py-3 bg-primary text-white rounded-xl text-sm font-bold disabled:opacity-50 transition-colors"
                >
                  Create List
                </button>
              </div>
          ...
          >
            ...
            >
              <div className="p-4 border-b border-border flex items-center justify-between shrink-0">
                ...
                <button type="button" onClick={() => setShowSend(false)} className="p-2 hover:bg-secondary rounded-full">
                  <X size={20} className="text-muted-foreground" />
                </button>
              </div>
              ...
              <div className="p-4 flex-1 overflow-y-auto">
                <textarea
                  ...
                  rows={5}
                  className="w-full bg-secondary rounded-xl px-4 py-3 text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-primary placeholder:text-muted-foreground resize-none"
                />
              ...
              <div className="p-4 border-t border-border shrink-0">
                <button
                  ...
                  className="w-full py-3 bg-primary text-white rounded-xl text-sm font-bold disabled:opacity-50 transition-colors flex items-center justify-center gap-2"
                >
                  {sendingBroadcast ? (
                    <>
