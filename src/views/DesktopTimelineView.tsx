...
import { Clock, Image, Plus, X, Loader, MessageSquare, Globe, Users, Lock } from 'lucide-react';
import { useAuthStore } from '@/store/useAuthStore';
import {
  isFirestoreAvailable, addDocToCollection, deleteDocById,
  subscribeToCollection, COLLECTIONS, serverTimestamp,
} from '@/lib/firestore';
...
function mapPost(d: Record<string, unknown>): TimelinePost {
...
export default function DesktopTimelineView() {
  ...
  }, [user, content, images, posting, visibility]);
  ...
  const handleDelete = useCallback(async (postId: string) => {
    ...
    try {
      ...
      // Subscription will restore the post on next snapshot
    }
  }, []);
