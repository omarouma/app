    ...
    <div className="bg-card min-h-[100dvh]">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-muted-foreground text-sm mb-8">Last updated: January 2026 | Governing Law: Applicable in your jurisdiction</p>
          ...
          <div className="space-y-8 text-muted-foreground text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">2. Eligibility</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">3. User Conduct</h2>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">4. Account Security</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">5. Intellectual Property</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">6. Wallet & Gaga Coins</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">7. Content Moderation</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">8. Termination</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">10. Dispute Resolution</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">11. Changes to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">12. Contact</h2>
