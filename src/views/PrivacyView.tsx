        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="space-y-8 text-[#8D8D8D] text-sm leading-relaxed">
            <section>
              ...
              <p className="mb-2">
                GaGa collects information you provide directly when you register, including your name, email address, phone number, profile photo, and the messages you send. We also collect:
              </p>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>Provide, maintain, and improve GaGa services</li>
            ...
            <section>
              ...
              <p>
                Your messages are protected with end-to-end encryption (E2EE). This means only you and the recipient can read your messages. Neither GaGa nor any third party can access the content of your encrypted messages. We use industry-standard encryption protocols (TLS 1.3 for transit, AES-256 for stored data) to protect your communications.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                GaGa is not intended for children under 13. We do not knowingly collect data from children under 13. If we discover that a child under 13 has provided personal data, we will delete it immediately. For users aged 13-17, parental consent is required for wallet features.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                We may update this Privacy Policy from time to time. We will notify you of significant changes through the app or via email. Continued use of GaGa after changes constitutes acceptance of the updated policy.
              </p>
            </section>
