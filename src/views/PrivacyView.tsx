    ...
    <div className="bg-card min-h-[100dvh]">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-muted-foreground text-sm mb-8">Last updated: January 2026 | Effective globally</p>
          ...
          <div className="space-y-8 text-muted-foreground text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">3. End-to-End Encryption</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">4. Data Storage & Location</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">5. Data Sharing & Third Parties</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">6. Digital Security Act 2018 Compliance</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">7. Your Rights</h2>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">8. Wallet & Financial Data</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">9. Cookies & Tracking</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">10. Children's Privacy</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">11. Changes to This Policy</h2>
              <p>
            ...
            <section>
              <h2 className="text-foreground font-semibold text-base mb-3">12. Contact Us</h2>
              <p className="mb-2">
                If you have questions about this Privacy Policy or your data rights, please contact us:
              </p>
              <div className="bg-secondary rounded-xl p-4 text-foreground">
