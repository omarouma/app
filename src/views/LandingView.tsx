...
export default function LandingView() {
  ...
  return (
    <div className="bg-background text-foreground min-h-[100dvh]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 mb-4">
              ...
              <span className="text-primary text-sm font-medium">Everything you need in one place</span>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 mb-5">
                ...
                <span className="text-primary text-sm font-medium">For Creators</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button type="button" onClick={() => navigate('/creators')}
                  className="bg-primary hover:bg-[#00A300] text-white rounded-full px-8 py-3 text-sm font-bold transition-colors inline-flex items-center justify-center gap-2"
                >
                  Explore Creator Center <ArrowRight size={16} />
                </button>
                <button type="button" onClick={() => navigate('/auth')}
                  className="bg-card border-2 border-gray-200 hover:border-primary text-gray-900 rounded-full px-8 py-3 text-sm font-bold transition-colors inline-flex items-center justify-center gap-2"
                >
                  Become a Creator
                </button>
              </div>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-card border border-gray-200 rounded-3xl p-5 shadow-lg">
                <div className="flex items-center gap-3 pb-4 border-b border-gray-200">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-[#00A300] flex items-center justify-center">
                    <Logo size={32} />
                  </div>
                  <div>
      ...
      {/* FAQ Section */}
      <section className="py-24 border-t border-gray-200 bg-card">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">Everything you need to know about GaGa Chat</p>
          </motion.div>
            ...
            {[
              ...
              <motion.div key={i} initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }}>
                <button
                  ...
                  className={`w-full text-left bg-secondary border rounded-2xl p-5 transition-all ${openFaq === i ? 'border-primary/30 bg-card shadow-sm' : 'border-border hover:border-primary/20'}`}
                >
                  <div className="flex items-center justify-between gap-4">
                    <span className="text-foreground font-semibold text-sm">{faq.q}</span>
                    <ChevronDown size={18} className={`text-muted-foreground shrink-0 transition-transform ${openFaq === i ? 'rotate-180' : ''}`} />
                  </div>
                  <AnimatePresence>
                    {openFaq === i && (
                      <motion.div
                      ...
                      >
                        <p className="text-muted-foreground text-sm leading-relaxed mt-3 pt-3 border-t border-border/60">
                          {faq.a}
                        </p>
                      </motion.div>
                    )}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 mb-4">
              ...
              <span className="text-primary text-sm font-medium">Why GaGa?</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">GaGa Chat vs Others</h2>
            <p className="text-muted-foreground max-w-lg mx-auto">See how GaGa Chat compares to the most popular messaging apps</p>
          </motion.div>

          <div className="overflow-x-auto -mx-4 px-4">
            <div className="min-w-full sm:min-w-[600px]">
              <div className="grid grid-cols-4 gap-3 mb-3">
                <div className="text-sm font-semibold text-muted-foreground p-3">Feature</div>
                <div className="text-sm font-bold text-primary p-3 bg-primary/5 rounded-xl text-center">GaGa Chat</div>
                <div className="text-sm font-semibold text-muted-foreground p-3 text-center">WhatsApp</div>
                <div className="text-sm font-semibold text-muted-foreground p-3 text-center">Telegram</div>
              </div>
              {[
                ...
                <motion.div key={row.feature} initial={{ opacity: 0, x: -10 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.03 }}
                  className={`grid grid-cols-4 gap-3 items-center ${i % 2 === 0 ? 'bg-card' : 'bg-secondary'} rounded-xl p-3 mb-1`}
                >
                  <span className="text-sm text-foreground font-medium">{row.feature}</span>
                  <div className="flex justify-center">
                    {row.gaga ? <CheckCircle size={18} className="text-primary" /> : <span className="text-muted-foreground text-sm">—</span>}
                  </div>
                  <div className="flex justify-center">
                    {row.wa ? <CheckCircle size={18} className="text-muted-foreground" /> : <span className="text-muted-foreground text-sm">—</span>}
                  </div>
                  <div className="flex justify-center">
                    {row.tg ? <CheckCircle size={18} className="text-muted-foreground" /> : <span className="text-muted-foreground text-sm">—</span>}
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="text-center mt-8">
            <p className="text-muted-foreground text-xs">Comparison based on publicly available features as of 2025. Features may change over time.</p>
          </motion.div>
        </div>
      </section>

      {/* Security */}
      <section id="security" className="py-24 border-t border-border bg-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 mb-6">
                <Shield size={14} className="text-primary" />
                <span className="text-primary text-sm font-medium">{t('securityFirst')}</span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">{t('yourPrivacy')}</h2>
              <p className="text-muted-foreground mb-6 leading-relaxed">{t('privacyDesc')}</p>
              ...
              <div className="bg-card border border-border rounded-3xl p-6 space-y-4 shadow-sm">
                <div className="flex items-center gap-3 pb-4 border-b border-border">
                  ...
                  <div>
                    ...
                    <p className="text-primary text-xs flex items-center gap-1">
                      <span className="w-1.5 h-1.5 rounded-full bg-primary" />{t('encrypted')}
                    </p>
                  </div>
                </div>
                {[
                  ...
                  <motion.div key={i} initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                    ...
                    <div className={`max-w-[80%] px-4 py-2.5 rounded-2xl ${msg.me ? 'bg-primary text-white rounded-br-sm' : 'bg-secondary text-foreground rounded-bl-sm'}`}>
      ...
      <section className="py-24 border-t border-border bg-secondary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-card border border-border rounded-3xl p-8 sm:p-12 relative overflow-hidden"
          >
            ...
            <div className="flex flex-col sm:flex-row items-start gap-6">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-foreground mb-3">{t('foundersNote')}</h3>
                <p className="text-muted-foreground leading-relaxed mb-4">{t('foundersMessage')}</p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center text-primary font-bold text-sm">
                    OG
                  </div>
                  <div>
                    <p className="text-foreground text-sm font-medium">{t('foundersName')}</p>
                    <p className="text-muted-foreground text-xs">{t('foundersTitle')}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 border-t border-border bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">{t('earlyUserFeedback')}</h2>
            <p className="text-muted-foreground max-w-lg mx-auto">{t('testimonialsDesc')}</p>
          </motion.div>
            ...
            {testimonials.map((testimonial, i) => {
              ...
              return (
                <motion.div key={testimonial.name} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                  className="bg-secondary border border-border rounded-2xl p-6 hover:border-primary/30 transition-all hover:shadow-lg hover:-translate-y-1">
                  <div className="flex gap-0.5 mb-4">
                    {[1, 2, 3, 4, 5].map(s => <span key={s} className="text-primary text-sm">★</span>)}
                  </div>
                  <p className="text-foreground text-sm leading-relaxed mb-5">&ldquo;{testimonial.text}&rdquo;</p>
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full flex items-center justify-center overflow-hidden bg-primary">
                      {avatar?.src
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-1.5 mb-5">
                ...
                <span className="text-primary text-sm font-medium">Install on Any Device</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                {canInstall || isIOS ? (
                  <button type="button" onClick={triggerInstall}
                    className="bg-primary hover:bg-[#00A300] text-white rounded-full px-8 py-4 text-sm font-bold transition-colors inline-flex items-center justify-center gap-2"
                  >
            ...
            <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="flex justify-center">
              <div className="bg-card border border-border rounded-3xl p-6 shadow-lg max-w-xs w-full">
                <div className="flex items-center justify-center mb-6">
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary to-[#00A300] flex items-center justify-center shadow-lg shadow-[#00C300]/20">
                    <Logo size={48} />
                  </div>
                </div>
                <div className="text-center mb-4">
                  <p className="font-bold text-foreground text-lg mb-1">GaGa Chat</p>
                  <p className="text-muted-foreground text-xs">Free messaging & calls</p>
                </div>
                ...
                <button type="button" onClick={() => navigate('/auth')}
                  className="w-full py-3 bg-primary hover:bg-[#00A300] text-white rounded-xl text-sm font-bold transition-colors"
                >
                  Get Started
                </button>
              </div>
      ...
      <section className="py-24 border-t border-border bg-secondary">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <h2 className="text-3xl sm:text-5xl font-bold text-foreground mb-6">{t('readyToStart')}</h2>
          <p className="text-muted-foreground mb-8">{t('joinFounding')}</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button type="button" onClick={() => navigate('/auth')}
              className="bg-primary hover:bg-[#00A300] text-white rounded-full px-10 py-4 text-lg font-bold transition-colors inline-flex items-center justify-center gap-2"
            >
              {t('getStarted')} <ArrowRight size={20} />
            </button>
            <button type="button" onClick={() => navigate('/auth')}
              className="bg-card border-2 border-border hover:border-primary text-foreground rounded-full px-10 py-4 text-lg font-bold transition-colors inline-flex items-center justify-center gap-2"
            >
              <Users size={20} /> Invite Friends
            </button>
          </div>
          <p className="text-muted-foreground text-xs mt-6">No credit card required. Free forever.</p>
        </motion.div>
      </section>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-bold text-foreground">Install GaGa Chat</h3>
                <button type="button" onClick={dismissIOSGuide} className="p-1 text-muted-foreground hover:text-foreground">
                  <X size={20} />
                </button>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-xs">Tap the <Share size={12} className="inline mx-0.5" /> icon at the bottom of Safari.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-xs">Look for the + icon and tap it.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-foreground text-sm font-medium">Tap "Add"</p>
                    <p className="text-muted-foreground text-xs">The app will appear on your home screen like a native app.</p>
                  </div>
                </div>
              </div>
              <button type="button" onClick={dismissIOSGuide}
                className="w-full mt-5 py-3 bg-primary text-white rounded-xl text-sm font-bold hover:bg-[#00A300] transition-colors"
              >
                Got it
              </button>
            </motion.div>
