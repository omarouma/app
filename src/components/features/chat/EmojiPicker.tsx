...
const emojiCategories: Record<string, string[]> = {
  'Recent': ['\u{1F44D}', '\u{2764}', '\u{1F602}', '\u{1F62E}', '\u{1F64F}'],
  ...
  return (
    <div className="relative">
      <button type="button" onClick={() => setShow(!show)}
        className="text-[#8D8D8D] hover:text-[#00C300] p-1.5 rounded-full hover:bg-[#F5F5F5] transition-colors"
      >
        <Smile size={20} />
      </button>
      ...
      {show && (
        <>
          ...
          <div className="absolute bottom-12 right-0 w-72 p-2 bg-white border border-[#EBEBEB] rounded-2xl shadow-xl z-50">
