  ...
  if (!card) {
    return (
      <div className={`max-w-[70%]`}>
        <div className={`inline-block px-4 py-3 rounded-2xl ${isMe ? 'bg-primary text-primary-foreground rounded-br-none' : 'bg-secondary text-foreground rounded-bl-none'} shadow-sm`}>
        ...
        {card.userId && (
          <div className="mt-2 flex gap-1.5">
            <button
              ...
              className={`flex-1 py-1.5 rounded-lg text-xs font-medium transition-colors flex items-center justify-center gap-1 ${isMe ? 'bg-white/20 text-white hover:bg-white/30' : 'bg-background text-foreground hover:bg-accent'}`}
            >
