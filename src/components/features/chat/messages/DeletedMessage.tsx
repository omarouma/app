...
export const DeletedMessage = memo(function DeletedMessage(props: DeletedMessageProps) {
  ...
  return (
    <div className={`inline-block px-3 py-2 rounded-2xl text-[13px] italic ${isMe ? 'bg-[#00C300]/60 text-white/80 rounded-br-none' : 'bg-muted text-muted-foreground rounded-bl-none'}`} aria-live="polite">
