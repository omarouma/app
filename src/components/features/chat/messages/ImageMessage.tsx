...
export const ImageMessage = memo(function ImageMessage(props: ImageMessageProps) {
  ...
  return (
    <div className="relative intro max-w-full group">
      ...
      {!loaded && (
        <div className="rounded-2xl mb-1 h-40 bg-[#F5F5F5] animate-pulse flex flex-col items-center justify-center gap-2">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#C7C7CC" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
